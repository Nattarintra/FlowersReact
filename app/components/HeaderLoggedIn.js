...
function HeaderLoggedIn(props) {
  ...
  return (
    <div className="flex-row my-3 my-md-0">
      ...
      <span onClick={() => appDispatch({ type: "toggleChat" })} data-for="chat" data-tip="Chat" className={"mr-2 header-chat-icon text-white " + (appState.unReadChatCount ? "text-danger" : "text-white")}>
