...
function HomeGuest() {
    ...
    switch (action.type) {
      ...
      case "emailAfterDelay":
        if (!/^\S+@\S+$/.test(draft.email.value)) {
          ...
          draft.email.message = "you must provide a valide email adress."
        }
  ...
  const [state, dispatch] = useImmerReducer(flowerReducer, initialState)
        ...
        <div className="col-lg-5 pl-lg-5 pb-3 py-lg-5">
          <form onSubmit={handleSubmit}>
            <div className="form-group">
              ...
              {/* check warning message if in={state.username.hasErrors} */}
